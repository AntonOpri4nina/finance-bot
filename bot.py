...
async def cmd_start(message: types.Message, command: CommandObject, state: FSMContext):
    try:
        ...
        text = (
            ...
            "Изучите доступные предложения и выберите то, что соответствует вашим потребностям. "
            "Мы здесь, чтобы помочь вам сделать правильный выбор!"
        )
...
async def callback_handler(callback_query: types.CallbackQuery, state: FSMContext):
    ...
    try:
        ...
        if data == 'start_menu':
            ...
            msg = await bot.send_message(chat_id, "Выбери финпродукт, который тебя интересует:", reply_markup=get_main_menu())
            await state.update_data(last_bot_message_id=msg.message_id)
            ...
            msg = await bot.send_message(chat_id,
                ...
                "Получите займ без переплат, выбрав проверенную организацию из нашего тщательно отобранного списка.",
            ...
            if mfo_name in mfo_info:
                ...
                texts = {
                    'express': (
                        ...
                        "📆 Срок: до 52 недель\n\n"
                        "⚡️ Решение моментально!\n\n"
                        "<b>Тарифы:</b>\n"
                        "🆕 Новый клиент: от 1 000 до 30 000 ₽ — до 29 дня <b>0%</b>, далее 0,6%/день\n"
                        "📈 Долгосрочный: от 31 000 до 100 000 ₽ — 0,6%/день"
                    ),
                    'urgent': (
                        "💸 <b>Срочноденьги</b>\n\n"
                        "🎉 <b>Первый заём бесплатно!</b>\n\n"
                        "💵 Сумма: от 2 000 до 30 000 ₽\n"
                        "📆 Срок: до 30 дней\n"
                        "🥇 Первый заём бесплатно (до 7 дней)\n\n"
                        "🪪 Только паспорт\n"
                        "⚡️ До 8 минут — деньги на карте!\n\n"
                        "🔞 Возраст: 18–65 лет | 🇷🇺 Гражданство РФ\n"
                        "🌍 Все регионы РФ, кроме: Крым, Дагестан, Чечня, ДНР, ЛНР"
                    ),
                    'amoney': (
                        "💳 <b>Кредитный лимит от «А Деньги»</b>\n\n"
                        "⚡️ Быстрое одобрение + удобство кредитки!\n\n"
                        "🎁 Для новых клиентов первые 7 дней — бесплатно!\n"
                        "💸 Далее — 8 руб./день за каждую 1 000 ₽\n\n"
                        "💵 Сумма: до 30 000 ₽ | 📆 Срок: до 30 дней с автопродлением\n"
                        "❌ Без поручителей, справок и залога\n"
                        "🔞 Возраст: 18–75 лет | 🇷🇺 Гражданство РФ"
                    ),
                    'rocket': (
                        "🚀 <b>РокетМЭН</b>\n\n"
                    ...
                    'nebus': (
                        "🌐 <b>Небус</b>\n\n"
                        "🔞 Возраст: от 18 до 88 лет | 🪪 Паспорт РФ\n\n"
                    ...
                    'dobro': (
                        ...
                        "🪪 Только паспорт РФ | 🔞 От 19 до 90 лет\n"
                    ...
                    'finmoll': (
                        ...
                        "📆 Срок: до 52 недель | 💳 Платежи: еженедельно\n"
                        "💸 Ставка: от 215% до 250% годовых\n"
                        "❌ Без залога и поручительства\n\n"
                        "🇷🇺 Гражданство РФ | 🔞 18–70 лет (первичные), 18–75 лет (повторные)\n"
            ...
            pts_texts = {
                "pts_drive": (
                    ...
                    "🚗 ТС остается у вас. Иномарки не старше 2005 г., отечественные 2010 г."
                ),
                "pts_kredi": (
                    "🏦 <b>Креди</b>\n\n"
                    "💵 Сумма: от 50 000 до 500 000 ₽\n"
                    "⏳ Срок: от 3 мес до 4 лет\n"
                    "⏱️ Рассмотрение: 30 минут\n\n"
                    "🚘 Легковые: отечественные до 7 лет, иномарки до 20 лет\n"
                    "🚚 Грузовые: отечественные до 10 лет, иномарки до 15 лет\n"
                    "💳 Получение: на банковскую карту, СБП"
                ),
                "pts_cashdrive": (
                    "💸 <b>КэшДрайв</b>\n\n"
                    "👤 Гражданство РФ | 🔞 Возраст: 21–70 лет\n\n"
                ...
                "pts_sovcom": (
                    ...
                    "🌟 Онлайн заявка, получение день в день, авто остается у вас\n\n"
                    "📄 Документы: паспорт РФ, СНИЛС или ВУ, СТС, ПТС, ОСАГО"
                ),
            }
            ...
            msg = await bot.send_message(chat_id,
                ...
                "🔍 Другие финансовые инструменты с оптимальными условиями.",
            ...
            msg = await bot.send_message(chat_id,
                ...
                "🔹 Квартира, дом или коммерческая недвижимость — вы остаетесь собственником\n"
...
async def help_command_handler(message: types.Message):
    if message.from_user.id in ADMIN_IDS:
        ...
        text = (
            "ℹ️ Я бот для оформления займов. Выберите нужную опцию в меню.\n"
